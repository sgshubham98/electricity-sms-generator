...
const DISCOMS: Discom[] = [
  ...
  // Bihar
  { name: 'NBPDCL', fullName: 'North Bihar Power', state: 'Bihar', lsa: 'B', brand: 'NBPDCL', isGovt: true, minAmt: 250, maxAmt: 2500, genCno: () => randDigits(11), sms: (c, m, a, d, b) => `UPBHOKTA KRYPA DHYAN DEIN: CA No. ${c} ka maah ${m} ka ${b} bijli bill Rs. ${a}/- hai. Antim tarikh ${d}. Samay par bhugtan karein (https://nbpdcl.co.in/).` },
  { name: 'SBPDCL', fullName: 'South Bihar Power', state: 'Bihar', lsa: 'B', brand: 'SBPDCL', isGovt: true, minAmt: 250, maxAmt: 2500, genCno: () => randDigits(11), sms: (c, m, a, d, b) => `UPBHOKTA KRYPA DHYAN DEIN: CA No. ${c} ka maah ${m} ka ${b} bijli bill Rs. ${a}/- hai. Antim tarikh ${d}. Samay par bhugtan karein (https://sbpdcl.co.in/).` },
  // Chandigarh
  ...
  // Chhattisgarh
  { name: 'CSPDCL', fullName: 'Chhattisgarh Power', state: 'Chhattisgarh', lsa: 'Y', brand: 'CSPDCL', isGovt: true, minAmt: 300, maxAmt: 2800, genCno: () => randDigits(10), sms: (c, m, a, d, b) => `Priye Upbhokta, BP No. ${c} ka maah ${m} ka ${b} bill Rs. ${a}/- hai. Deay Tithi: ${d}. https://cspdcl.co.in/ se pay karein.` },
  // Delhi
  ...
  // Madhya Pradesh
  { name: 'MPPKVVCL', fullName: 'MP Paschim Kshetra', state: 'Madhya Pradesh', lsa: 'Y', brand: 'MPWKVL', isGovt: true, minAmt: 350, maxAmt: 3200, genCno: () => randDigits(12), sms: (c, m, a, d, b) => `${b}: IVRS No. ${c} ka bill Rs. ${a}/- deay tithi ${d} tak URJA app pe jama karein.` },
  ...
  // Rajasthan
  { name: 'JVVNL', fullName: 'Jaipur Vidyut Vitran Nigam', state: 'Rajasthan', lsa: 'R', brand: 'JVVNLX', isGovt: true, minAmt: 400, maxAmt: 3500, genCno: () => randDigits(12), sms: (c, m, a, d, b) => `${b} Bijli Bill for K.No. ${c} is Rs. ${a}/-. Antim Tithi: ${d}. E-Mitra par jama karein.` },
  { name: 'AVVNL', fullName: 'Ajmer Vidyut Vitran Nigam', state: 'Rajasthan', lsa: 'R', brand: 'AVVNLX', isGovt: true, minAmt: 350, maxAmt: 3200, genCno: () => randDigits(12), sms: (c, m, a, d, b) => `${b} Bijli Bill for K.No. ${c} is Rs. ${a}/-. Antim Tithi: ${d}. E-Mitra par jama karein.` },
  { name: 'JDVVNL', fullName: 'Jodhpur Vidyut Vitran', state: 'Rajasthan', lsa: 'R', brand: 'JDVVNL', isGovt: true, minAmt: 350, maxAmt: 3200, genCno: () => randDigits(12), sms: (c, m, a, d, b) => `${b} Bijli Bill for K.No. ${c} is Rs. ${a}/-. Antim Tithi: ${d}. E-Mitra par jama karein.` },
  // Sikkim
  ...
  { name: 'PuVVNL', fullName: 'Purvanchal Vidyut Vitran', state: 'Uttar Pradesh', lsa: 'E', brand: 'PUVVNL', isGovt: true, minAmt: 350, maxAmt: 3500, genCno: () => randDigits(10), sms: (c, m, a, d, b) => `Priye Upbhokta, Account No. ${c} ka ${m} ka bijli bill Rs. ${a} hai. Deay tithi ${d} hai. Kripya uppclonline.com se samay par jama karein. -${b}` },
  { name: 'KESCO', fullName: 'Kanpur Electricity Supply', state: 'Uttar Pradesh', lsa: 'E', brand: 'KESCOX', isGovt: true, minAmt: 400, maxAmt: 4000, genCno: () => randDigits(10), sms: (c, m, a, d, b) => `Priye Upbhokta, Account No. ${c} ka ${m} ka bijli bill Rs. ${a} hai. Deay tithi ${d} hai. Kripya uppclonline.com se samay par jama karein. -${b}` },
  // Uttarakhand
